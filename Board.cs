...
namespace proje2_todo
{
	public class Board
	{
		...
		{   //Default Members
			...
			{
				new TeamMember(10,"Serhat Sakallı"),
				new TeamMember(20,"Samet Sakallı"),
				new TeamMember(30,"Batuhan Ata Çağlar"),
				new TeamMember(40,"Celal Baran"),
				new TeamMember(50,"Altan Kırmızıbayrak"),
				new TeamMember(60,"Galip Eryılmaz")
